...
def pred_link(dataset, epochs):
    ...
    adj, features, adj_train, val_edges, val_edges_false, test_edges, test_edges_false = load_data(dataset)
    ...
    x1 = tf.placeholder('float', [None, 16])
    x2 = tf.placeholder('float', [None, 16])
